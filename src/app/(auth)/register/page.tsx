      ...
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-12">
        ...
        <aside className="relative hidden lg:col-span-7 lg:flex lg:items-center lg:justify-center">
          ...
          <div className="relative z-10 max-w-md space-y-4 px-8 text-center">
            ...
            <h2 className="text-3xl font-semibold text-[var(--text-primary)]">Mulai catat lebih rapi.</h2>
            <p className="text-sm text-[var(--text-dimmed)]">
              Simpan pengeluaran, buat laporan, dan pantau saldo dari semua perangkat.
            </p>
          </div>
        </aside>
      </div>
